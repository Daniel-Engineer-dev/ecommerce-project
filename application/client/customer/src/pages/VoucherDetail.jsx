...
const VoucherDetail = () => {
  ...
  if (loading) return (
    <div style={{ paddingTop: '180px', textAlign: 'center', height: '100vh' }}>
  ...
  return (
    <div style={{ paddingTop: '180px', paddingBottom: '100px', background: '#f8fafc', minHeight: '100vh' }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '3rem', alignItems: 'start' }}>
          ...
          <aside style={{ position: 'sticky', top: '180px', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
