    ...
    <>
      <motion.article className="lux-voucher-card" onClick={goToDetail} whileHover={{ y: -4 }}>
        <div className="lux-voucher-card__media">
          ...
          <div className="lux-voucher-card__hover-actions">
            <button type="button" onClick={(event) => { event.stopPropagation(); setShowQuickView(true); }}>
              <Eye size={16} /> Xem nhanh
            </button>
            <button type="button" onClick={(event) => { event.stopPropagation(); goToDetail(); }}>
