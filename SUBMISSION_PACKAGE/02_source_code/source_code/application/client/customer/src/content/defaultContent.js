  ...
  "support-center": {
    ...
    data: {
      ...
      contact: {
        title: "Kênh liên hệ",
        description:
          "Nếu cần hỗ trợ trực tiếp, hãy liên hệ Dealzy qua các kênh bên dưới.",
        phone: "1900 6789",
  ...
  "refund-policy": {
    ...
    data: {
      hero: {
        ...
        title: "Chính sách hoàn tiền",
        description:
          "Thông tin về các trường hợp Dealzy tiếp nhận yêu cầu hoàn tiền voucher.",
      },
      sections: [
        {
  ...
  "terms-of-service": {
    ...
    data: {
      hero: {
        ...
        title: "Điều khoản dịch vụ",
        description:
          "Các điều khoản áp dụng khi người dùng truy cập và sử dụng website Dealzy.",
      },
      sections: [
        {
    ...
    data: {
      ...
      roadmap: [
        ...
        },
        {
          ...
          checklist: [
            "Nhập từ khóa sản phẩm hoặc thương hiệu",
            "Chọn danh mục quan tâm",
            "Dùng bộ lọc khi có quá nhiều kết quả",
          ],
        },
        {
          phase: "Bước 03",
          ...
          checklist: [
            "Đọc kỹ điều kiện sử dụng",
            "Kiểm tra địa điểm áp dụng",
            "Xem thời hạn và chính sách hoàn hủy",
          ],
        },
        {
          phase: "Bước 04",
          ...
          checklist: [
            "Kiểm tra số lượng",
            "Xóa voucher không cần mua",
            "Đảm bảo voucher còn hiệu lực",
          ],
        },
        {
          phase: "Bước 05",
        ...
        },
        {
          ...
          checklist: [
            "Lưu mã QR hoặc mã voucher",
            "Xuất trình mã tại điểm sử dụng",
      ...
      cta: {
        ...
        description:
          "Trung tâm hỗ trợ có thể giúp bạn kiểm tra thanh toán, trạng thái đơn hàng và mã E-Voucher.",
  ...
  "home-banner": {
    ...
    data: {
      hero: {
        ...
        image:
          "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&q=82&w=1300",
      },
      proofs: [
      ...
      tiles: [
        {
          ...
          image:
            "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&q=82&w=900",
        },
        {
          title: "Wellness",
          copy: "Spa, làm đẹp và chăm sóc sức khỏe cuối tuần.",
          image:
            "https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&q=82&w=900",
        },
      ],
    },
  },
